    ...
    <div class="hero-body">
        <div class="container has-text-centered">
            <div class="container">
                ...
                <h2 id="modern-framework" class="subtitle"> ระบบรับเรื่องร้องเรียนและคุ้มครองการละเมิดสิทธิด้านเอดส์
                </h2>
            ...
            <table class="table has-text-centered  is-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>RTF (มูลนิธิรักษ์ไทย)</th>
                        <td>ตราด</td>
                        <td>998 ถนน ชลประทาน ต. วังกระแจะ อ. เมือง จ. ตราด 23000</td>
                    </tr>
                    <tr>
                        <th>RTF (มูลนิธิรักษ์ไทย)</th>
                        <td>นครปฐม</td>
                    ...
                    <tr>
                        <th>RTF (มูลนิธิรักษ์ไทย)</th>
                        <td>นครศรีธรรมราช</td>
                        <td>110/13-14 ซอย สันติสุข ถนน เอเชีย ต. โพธิ์เสด็จ อ. เมือง จ. นครศรีธรรมราช 80000</td>
                    </tr>
                    <tr>
                        <th>RSAT(สมาคมฟ้าสีรุ้ง)</th>
                        <td>นนทบุรี</td>
                    ...
                    <tr>
                        <th>RTF (มูลนิธิรักษ์ไทย)</th>
                        <td>สุราษฎร์ธานี</td>
                        <td>200/3-4 หมู่ 5 หมู่บ้าน เอกธานี ถ. เลี่ยงเมือง ต. มะขามเตี้ย อ. เมือง จ. สุราษฎร์ธานี 84000
                        </td>
                    </tr>
                    <tr>
                        <th>RSAT(สมาคมฟ้าสีรุ้ง)</th>
                ...
                <div class="tile is-parent">
                    <article class="tile is-child box">
                        ...
                        <p>1.ถูกบังคับตรวจเอชไอวี <br>
                            ...
                            * กลุ่มเปราะบาง ได้แก่ กลุ่มหลากหลายทางเพศ, พนักงานบริการ, ผู้ใช้สารเสพติด, ประชากรข้ามชาติ,
                            ผู้ถูกคุมขัง, กลุ่มชาติพันธุ์และชนเผ่า
                        </p>
                    </article>
                </div>
            </div>
