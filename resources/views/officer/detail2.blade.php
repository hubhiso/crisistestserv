    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ route('officer.post_detail') }}">
        ...
        <div class="container">
            <nav class="breadcrumb">
                <ul>
                    ...
                    <li class="is-active"><a><span class="icon is-small"><i class="fa fa-address-card"></i></span><span>
                                ข้อมูลเพิ่มเติม </span></a>
                    </li>
                </ul>
            </nav>
        </div>
        ...
        <div class="container">
                        ...
                        <div class="field is-grouped">
                            <div class="control is-expanded ">
                                ...
                                <a class="button is-primary "
                                    href="{{asset('/uploads/'.$show_data->case_id.'/'.$show_data->file1)}}" download>
                                    <span class="icon is-left">
                                        <i class="fas fa-file-alt"></i>
                                    </span>
                                ...
                                @else
                                <a class="button is-primary "
                                    href="{{asset('/uploads/'.$show_data->case_id.'/'.$show_data->file2)}}" download>
                                    <span class="icon is-left">
                                        <i class="fas fa-file-alt"></i>
                                    </span>
                                ...
                                @else
                                <a class="button is-primary "
                                    href="{{asset('/uploads/'.$show_data->case_id.'/'.$show_data->file3)}}" download>
                                    <span class="icon is-left">
                                        <i class="fas fa-file-alt"></i>
                                    </span>
            ...
            <div class="notification">
                        ...
                        <div class="field is-grouped">
                            <p class="control  has-icons-left ">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    ปี พ.ศ. : <input type="number" min="2561" max="2570" value={{ date("Y")+543 }}
                                        id="YearInterview" name="YearInterview" class="form-control" placeholder="ปปปป"
                    ...
                    <div class="field-body">
                        <div class="field is-grouped">
                            <p class="control  has-icons-left ">
                                <!--This container is birth_date input. -->
                                <div class="input-group date" data-provide="datepicker">
                                    ปี พ.ศ. : <input type="number" min="2400" max="2570" maxlength="4" id="yearInput"
                                        name="yearInput" class="form-control" placeholder="ปปปป"
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body is-expanded">
                        ...
                        <div class="field">
                            <p class="control  has-icons-left has-icons-right">
                                {!! Form::text('card_num',null,['class'=>'input','placeholder' => 'ID-CODE','maxlength'
                                => 13 ])!!}
                            </p>
                        </div>
                    </div>
            ...
            <div class="notification">
                    ...
                    <div class="field-body">
                        <div class="field is-grouped">
                            <p class="control  has-icons-left ">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    ปี พ.ศ. : <input type="number" min="2561" max="2570" value={{ date("Y")+543 }}
                                        id="YearAct" name="YearAct" class="form-control" placeholder="ปปปป"
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        ...
                        <div class="field is-narrow is-grouped">
                            <div class="control"> <span class="select">
                                    <select id="sub_problem" name="sub_problem" @if($show_data->sub_problem == null){
                                        disabled } @endif>
                        ...
                        <div class="field is-narrow is-grouped">
                            <div class="control"> <span class="select">
                                    <select id="group_code" name="group_code" @if($show_data->group_code == null){
                                        ...
                                        <option value="1" style="width:250px" @if($show_data->group_code == 1){ selected
                                            } @endif>กลุ่มหลากหลายทางเพศ</option>
                                        <option value="2" style="width:250px" @if($show_data->group_code == 2){ selected
                                            } @endif>พนักงานบริการ</option>
                                        <option value="3" style="width:250px" @if($show_data->group_code == 3){ selected
                                            } @endif>ผู้ใช้สารเสพติด</option>
                                        <option value="4" style="width:250px" @if($show_data->group_code == 4){ selected
                                            } @endif>ประชากรข้ามชาติ</option>
                                        <option value="5" style="width:250px" @if($show_data->group_code == 5){ selected
                                            } @endif>ผู้ต้องขัง</option>
                                        <option value="6" style="width:250px" @if($show_data->group_code == 6){ selected
                                            } @endif>กลุ่มชนเผ่า</option>
                                        @endif
            ...
            <div class="field is-grouped">
                ...
                <p class="control"> <a class="button" href="{{ route('officer.show',['mode_id' => "0"]) }}"> ยกเลิก </a>
                </p>
            </div>
        </div>
</section>
