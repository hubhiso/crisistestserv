        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ route('officer.update_detail') }}">
            ...
            <div class="container">
                <nav class="breadcrumb">
                    <ul>
                        <li><a href="{{ route('officer.show',['mode_id' => "0"]) }}"><span class="icon is-small"><i
                                        class="fa fa-home"></i></span><span> หน้าหลัก </span></a>
                        </li>
                        <li class="is-active"><a><span class="icon is-small"><i
                                        class="fa fa-address-card"></i></span><span> ข้อมูลเพิ่มเติม </span></a>
                        </li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="container">
                            ...
                            <div class="field is-grouped">
                                <p class="control  has-icons-left ">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        ปี พ.ศ. : <input type="number" min="2561" max="2570" maxlength="4"
                                            id="YearInterview" name="YearInterview" class="form-control"
                                            placeholder="ปปปป"
                                            value="{{date('Y',strtotime(str_replace('-','/', $show_detail->interview_date)))+543 }}"
                                            onchange="date_interview();createinterviewdate()">
                                        เดือน : <select id="MonthInterview" name="MonthInterview"
                                            onchange="date_interview();createinterviewdate();">
                                            <option value="1" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 1){ selected } @endif> มกราคม </option>
                                            <option value="2" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 2){ selected } @endif> กุมภาพันธ์ </option>
                                            <option value="3" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 3){ selected } @endif> มีนาคม </option>
                                            <option value="4" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 4){ selected } @endif> เมษายน </option>
                                            <option value="5" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 5){ selected } @endif> พฤษภาคม </option>
                                            <option value="6" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 6){ selected } @endif> มิถุนายน </option>
                                            <option value="7" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 7){ selected } @endif> กรกฎาคม </option>
                                            <option value="8" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 8){ selected } @endif> สิงหาคม </option>
                                            <option value="9" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                interview_date))) == 9){ selected } @endif> กันยายน </option>
                                            <option value="10" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->interview_date))) == 10){ selected } @endif> ตุลาคม
                                            </option>
                                            <option value="11" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->interview_date))) == 11){ selected } @endif> พฤศจิกายน
                                            </option>
                                            <option value="12" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->interview_date))) == 12){ selected } @endif> ธันวาคม
                                            </option>
                                        </select>
                                        วันที่ : <select id="DayInterview" name="DayInterview"
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <p class="control  has-icons-left ">
                                    <div class="input-group date" data-provide="datepicker">
                                        ปี พ.ศ. : <input type="number" min="2400" max="2570" maxlength="4"
                                            id="yearInput" name="yearInput" class="form-control" placeholder="ปปปป"
                                            value="{{date('Y',strtotime(str_replace('-','/', $show_detail->birth_date))) + 543 }}"
                                            onchange="date_birth();createbirthdate();">
                                        เดือน : <select id="monthInput" name="monthdate"
                                            onchange="date_birth();createbirthdate();">
                                            <option value="1" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 1){ selected } @endif> มกราคม </option>
                                            <option value="2" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 2){ selected } @endif> กุมภาพันธ์ </option>
                                            <option value="3" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 3){ selected } @endif> มีนาคม </option>
                                            <option value="4" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 4){ selected } @endif> เมษายน </option>
                                            <option value="5" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 5){ selected } @endif> พฤษภาคม </option>
                                            <option value="6" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 6){ selected } @endif> มิถุนายน </option>
                                            <option value="7" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 7){ selected } @endif> กรกฎาคม </option>
                                            <option value="8" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 8){ selected } @endif> สิงหาคม </option>
                                            <option value="9" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                birth_date))) == 9){ selected } @endif> กันยายน </option>
                                            <option value="10" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->birth_date))) == 10){ selected } @endif> ตุลาคม </option>
                                            <option value="11" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->birth_date))) == 11){ selected } @endif> พฤศจิกายน
                                            </option>
                                            <option value="12" @if(date('m',strtotime(str_replace('-','/',
                                                $show_detail->birth_date))) == 12){ selected } @endif> ธันวาคม </option>
                                        </select>
                                        วันที่ : <select id="dayInput" name="birthdate" onchange="createbirthdate();">
                                            @for ($i = 1; $i <= 31; $i++) <option value="{{$i}}"
                                                @if(date('d',strtotime(str_replace('-','/', $show_detail->birth_date)))
                            ...
                            <div class="field is-narrow">
                                <div class="control"> <span class="select">
                                        <select id="occupation" name="occupation">
                                            <option value="0" @if($show_detail->occupation == 0){ selected } @endif>
                                                โปรดเลือก </option>
                                            <option value="1" @if($show_detail->occupation == 1){ selected } @endif>
                                                ทำงานในหน่วยงานราชการ </option>
                                            <option value="2" @if($show_detail->occupation == 2){ selected } @endif>
                                                ทำงานในบริษัทเอกชน </option>
                                            <option value="3" @if($show_detail->occupation == 3){ selected } @endif>
                                                ทำงานในองค์กรพัฒนาเอกชน (NGO) </option>
                                            <option value="4" @if($show_detail->occupation == 4){ selected } @endif>
                                                ธุรกิจส่วนตัว </option>
                                            <option value="5" @if($show_detail->occupation == 5){ selected } @endif>
                                                รับจ้างทั่วไป </option>
                                            <option value="6" @if($show_detail->occupation == 6){ selected } @endif>
                                                เกษตรกร </option>
                                            <option value="7" @if($show_detail->occupation == 7){ selected } @endif>
                                                นักเรียน/นักศึกษา </option>
                                            <option value="8" @if($show_detail->occupation == 8){ selected } @endif>
                                                ว่างงาน </option>
                                            <option value="9" @if($show_detail->occupation == 9){ selected } @endif>
                                                อื่นๆ โปรดระบุ </option>
                                        </select>
                                    </span>
                                    <input class="input" id="occupation_detail" name="occupation_detail" type="text"
                                        value="{{$show_detail->occupation_detail}}" @if($show_detail->occupation != 9)
                            ...
                            <div class="field is-narrow ">
                                <div class="control"> <span class="select">
                                        <select id="card_type" name="card_type">
                                            <option value="1" @if($show_detail->card_type == 1){ selected } @endif>
                                                บัตรประชาชน </option>
                                            <option value="2" @if($show_detail->card_type == 2){ selected } @endif>
                                                บัตรต่างด้าว </option>
                                            <option value="3" @if($show_detail->card_type == 3){ selected } @endif>
                                                บัตรคนไทยไร้สถานะ </option>
                                            <option value="4" @if($show_detail->card_type == 4){ selected } @endif>
                                                พาสปอร์ต </option>
                                        </select>
                                    </span>
                                </div>
                ...
                <div class="notification">
                            ...
                            <div class="field is-narrow is-grouped">
                                <div class="control"> <span class="select">
                                        <select id="offender_type" name="offender_type">
                                            <option value="0" @if($show_detail->type_offender == 0){ selected } @endif>
                                                โปรดเลือก </option>
                                            <option value="1" @if($show_detail->type_offender == 1){ selected } @endif>
                                                สถานพยาบาล </option>
                                            <option value="2" @if($show_detail->type_offender == 2){ selected } @endif>
                                                สถานที่ทำงาน </option>
                                            <option value="3" @if($show_detail->type_offender == 3){ selected } @endif>
                                                สถานศึกษา </option>
                                            <option value="4" @if($show_detail->type_offender == 4){ selected } @endif>
                                                ตำรวจ </option>
                                            <option value="5" @if($show_detail->type_offender == 5){ selected } @endif>
                                                ทหาร </option>
                                            <option value="6" @if($show_detail->type_offender == 6){ selected } @endif>
                                                ท้องถิ่น </option>
                                            <option value="7" @if($show_detail->type_offender == 7){ selected } @endif>
                            ...
                            <div class="field is-narrow is-grouped">
                                <div class="control"> <span class="select">
                                        <select id="offender_subtype" name="offender_subtype"
                                            @if($show_detail->type_offender == 4||$show_detail->type_offender == 5)
                                            disabled @endif>
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <div class="control">
                                    <label class="radio">
                                        <input type="radio" name="type-violator" onclick="handleClick(this);" value="1"
                                            @if($show_detail->violator_name != ''){ checked } @endif >
                                        บุคคล
                                    </label>
                                </div>
                                <div class="control">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <p class="control  has-icons-left ">
                                    <!--This container is birth_date input. -->
                                    <div class="input-group date" data-provide="datepicker">
                                        ปี พ.ศ. : <input type="number" min="2561" max="2570" maxlength="4" id="YearAct"
                                            name="YearAct" class="form-control" placeholder="ปปปป"
                                            value="{{date('Y',strtotime(str_replace('-','/', $show_detail->accident_date))) + 543 }}"
                                            onchange="date_acc();createaccidentdate();">
                                        เดือน : <select id="MonthAct" name="MonthAct"
                                            onchange="date_acc();createaccidentdate();">
                                            <option value="1" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 1){ selected } @endif> มกราคม </option>
                                            <option value="2" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 2){ selected } @endif> กุมภาพันธ์ </option>
                                            <option value="3" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 3){ selected } @endif> มีนาคม </option>
                                            <option value="4" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 4){ selected } @endif> เมษายน </option>
                                            <option value="5" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 5){ selected } @endif> พฤษภาคม </option>
                                            <option value="6" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 6){ selected } @endif> มิถุนายน </option>
                                            <option value="7" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 7){ selected } @endif> กรกฎาคม </option>
                                            <option value="8" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 8){ selected } @endif> สิงหาคม </option>
                                            <option value="9" @if(date('m',strtotime(str_replace('-','/', $show_detail->
                                                accident_date))) == 9){ selected } @endif> กันยายน </option>
                                            <option value="10" @if(date('m',strtotime(str_replace('-','/',
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                                ...
                                <div class="control"> <span class="select">
                                        <select id="problem_case" name="problem_case">
                                            ...
                                            <option value="3" @if($show_data->problem_case == 3){ selected }
                                                @endif>ถูกกีดกันหรือถูกเลือกปฏิบัติเนื่องมาจาการติดเชื้อเอชไอวี</option>
                                            <option value="4" @if($show_data->problem_case == 4){ selected }
                                                @endif>ถูกกีดกันหรือถูกเลือกปฏิบัติเนื่องมาจากเป็นกลุ่มเปราะบาง</option>
                                            <option value="5" @if($show_data->problem_case == 5){ selected }
                                                @endif>กรณีอื่นๆ ที่เกี่ยวข้องกับเอชไอวี</option>
                            ...
                            <div class="field is-narrow is-grouped">
                                <div class="control"> <span class="select">
                                        <select id="sub_problem" name="sub_problem" @if($show_data->sub_problem ==
                                            ...
                                            <option value="4" style="width:250px" @if($show_data->sub_problem == 4){
                                                selected } @endif>ครอบครัวและผู้ใกล้ชิดผู้ติดเชื้อเอชไอวี</option>
                                            <option value="3" style="width:250px" @if($show_data->sub_problem == 3){
                            ...
                            <div class="field is-narrow is-grouped">
                                <div class="control"> <span class="select">
                                        <select id="group_code" name="group_code" @if($show_data->group_code == null){
                                            disabled } @endif>
                                            @if($show_data->sub_problem == 2)
                                            <option value="1" style="width:250px" @if($show_data->group_code == 1){
                                                selected } @endif>กลุ่มหลากหลายทางเพศ</option>
                                            <option value="2" style="width:250px" @if($show_data->group_code == 2){
                                                selected } @endif>พนักงานบริการ</option>
                                            <option value="3" style="width:250px" @if($show_data->group_code == 3){
                                                selected } @endif>ผู้ใช้สารเสพติด</option>
                                            <option value="4" style="width:250px" @if($show_data->group_code == 4){
                                                selected } @endif>ประชากรข้ามชาติ</option>
                                            <option value="5" style="width:250px" @if($show_data->group_code == 5){
                                                selected } @endif>ผู้ต้องขัง</option>
                                            <option value="6" style="width:250px" @if($show_data->group_code == 6){
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <div class="control">
                                    <label>
                                        <input type="checkbox" name="law" @if($show_detail->cause_type1 == 1){ checked }
                                        @endif>
                                        ไม่รู้กฎหมาย
                                    </label>
                                </div>
                                <div class="control">
                                    <label>
                                        <input type="checkbox" name="aids" @if($show_detail->cause_type2 == 1){ checked
                                        } @endif>
                                ...
                                <div class="control">
                                    <label>
                                        <input type="checkbox" name="attitude" @if($show_detail->cause_type3 == 1){
                                        checked } @endif>
                                        ทัศนคติ
                                    </label>
                                </div>
                                <div class="control">
                                    <label>
                                        <input type="checkbox" name="policy" @if($show_detail->cause_type4 == 1){
                                        checked } @endif>
                                        นโยบายองค์กร
                                    </label>
                                </div>
                                ...
                                <div class="control">
                                    <p>
                                        <input name="etc_detail" class="input" type="text" placeholder=""
                                            value="{{$show_detail->etc_detail}}" @if($show_detail->occupation != 1)
                                        style="display: none" @endif>
                ...
                <div class="field is-grouped">
                    ...
                    <p class="control"> <a class="button" href="{{ route('officer.show',['mode_id' => "0"]) }}"> ยกเลิก
                        </a> </p>
                </div>
            </div>
        </form>
